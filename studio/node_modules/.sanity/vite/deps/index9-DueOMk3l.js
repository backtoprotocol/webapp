...
import { I as Card, L as Flex, N as useToast, Nt as require_react_is, P as Box, Y as PortalProvider, Z as Stack, et as Text, h as Heading, jt as gt, l as Code, u as Container, yt as useTheme$1 } from "./dist-BYdwbOsU.js";
import "./Checkmark-BnsGfFwO.js";
import { Aa as _isCustomDocumentTypeDefinition, D_ as concat, Eh as v4, Fh as useRouterState, Hp as useTranslation, Kh as isEqual, L_ as ReplaySubject, Ld as useDocumentStore, N_ as of, P_ as from, Ph as useRouter, R_ as refCount, Rm as require_speakingurl, Sg as generateHelpUrl, Sp as useStudioErrorHandler, Wg as ResolvedPanesProvider, a_ as startWith, cl as isRecord$5, f_ as distinctUntilChanged, fg as Button, gh as isHotkey, i_ as switchMap, j_ as isObservable, l_ as scan, lh as omit, lm as useWorkspace, mg as ErrorBoundary, pi as SourceProvider, pp as useSchema, u_ as publishReplay, x_ as NEVER } from "./index2-CKVuV-mb.js";
import { c as createOperatorSubscriber, n as map, r as firstValueFrom, u as operate } from "./filter-BKOi1rGb.js";
...
import "./sanity.js";
import { N as useStructureTool, S as assignId, T as setActivePanes, X as SerializeError, Z as StructureToolProvider, b as StructureTitle, d as LoadingPane, ht as structureLocaleNamespace, u as LOADING_PANE, x as StructureToolPane, y as PaneLayout } from "./structureTool-Cc6JaS7O.js";
import "./Stack-MH4RbWiX.js";
import "./StackCompact-B0nMqq39.js";
...
//#endregion
//#region node_modules/sanity/lib/_chunks-es/index9.js
...
var isSerializable = (thing) => isRecord$5(thing) ? typeof thing.serialize == "function" : !1;
...
function resolvePaneTree({ unresolvedPane, flattenedRouterPanes, parent: parent2, path, resolvePane, structureContext }) {
	...
	try {
		return resolvePane(unresolvedPane, context, current.flatIndex).pipe(switchMap((paneNode) => {
			...
			let nextStream;
			return next?.routerPaneSibling.id.startsWith("__edit__") ? nextStream = resolvePaneTree({
		...
		if (e instanceof PaneResolutionError && (e.context && console.warn(`Pane resolution error at index ${e.context.index}${e.context.splitIndex > 0 ? ` for split pane index ${e.context.splitIndex}` : ""}: ${e.message}${e.helpId ? ` - see ${generateHelpUrl(e.helpId)}` : ""}`, e), e.helpId === "structure-item-returned-no-child")) return of([]);
		throw e;
	}
}
...
function useRouterPanesStream() {
	const $ = (0, import_compiler_runtime.c)(6), [routerStateSubject] = (0, import_react.useState)(_temp$4);
	let t0;
	$[0] !== routerStateSubject ? (t0 = routerStateSubject.asObservable().pipe(map(_temp2$3)), $[0] = routerStateSubject, $[1] = t0) : t0 = $[1];
	const routerPanes$ = t0, { state: routerState } = useRouter();
	let t1, t2;
...
function useResolvedPanes() {
	const $ = (0, import_compiler_runtime.c)(19), [error, setError] = (0, import_react.useState)(), [maximizedPane, setMaximizedPane] = (0, import_react.useState)(null);
	if (error) throw error;
	const { structureContext, rootPaneNode } = useStructureTool(), { navigate } = useRouter();
	let t0;
	...
	$[1] !== rootPaneNode || $[2] !== routerPanesStream || $[3] !== structureContext ? (t1 = () => {
		...
		routerPanesStream,
		structureContext
	], $[1] = rootPaneNode, $[2] = routerPanesStream, $[3] = structureContext, $[4] = t1, $[5] = t2) : (t1 = $[4], t2 = $[5]), (0, import_react.useEffect)(t1, t2);
	let t3, t4;
	...
	}, t4 = [data, navigate], $[6] = data, $[7] = navigate, $[8] = t3, $[9] = t4) : (t3 = $[8], t4 = $[9]), (0, import_react.useEffect)(t3, t4);
	let t5;
...
var IntentResolver = (0, import_react.memo)(function() {
	const $ = (0, import_compiler_runtime.c)(8), { navigate } = useRouter(), maybeIntent = useRouterState(_temp$3), { rootPaneNode, structureContext } = useStructureTool(), documentStore = useDocumentStore(), errorHandler = useStudioErrorHandler(), [error, setError] = (0, import_react.useState)(null);
	if (error) throw error;
	let t0, t1;
	return $[0] !== documentStore || $[1] !== errorHandler || $[2] !== maybeIntent || $[3] !== navigate || $[4] !== rootPaneNode || $[5] !== structureContext ? (t0 = () => {
		if (maybeIntent) {
			...
			return errorHandler.attempt(effect, { retryable: !0 }).catch(setError), () => {
				cancelled = !0;
			};
		}
	}, t1 = [
...
function _temp$3(routerState) {
	...
	return intentName ? {
		intent: intentName,
		params: isRecord$5(routerState.params) ? routerState.params : EMPTY_RECORD,
		payload: routerState.payload
	} : void 0;
}
var PathSegment = /* @__PURE__ */ gt.span.withConfig({
...
function StructureError(t0) {
	const $ = (0, import_compiler_runtime.c)(74), { error } = t0;
	if (!(error instanceof PaneResolutionError)) throw error;
	const { cause } = error, { t } = useTranslation(structureLocaleNamespace), stack = cause?.stack || error.stack;
	let t1;
	...
	if ($[4] !== cause || $[5] !== error.helpId || $[6] !== t) {
		...
		let t152;
		$[25] !== t ? (t152 = t("structure-error.header.text"), $[25] = t, $[26] = t152) : t152 = $[26], $[27] !== t152 ? (t9 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading, {
			as: "h2",
			children: t152
		}), $[27] = t152, $[28] = t9) : t9 = $[28], T0 = Card, t2 = 4, t3 = 4, t4 = 2, t5 = "auto", t6 = 1, t7 = "inherit", t8 = path.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Stack, {
			space: 2,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
				size: 1,
				weight: "medium",
				children: t("structure-error.structure-path.label")
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code, { children: path.slice(1).map(_temp2$2) })]
	...
	let t16;
	$[31] !== t15 ? (t16 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		size: 1,
		weight: "medium",
		children: t15
	...
	let t18;
	$[37] !== t17 ? (t18 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Code, { children: t17 }), $[37] = t17, $[38] = t18) : t18 = $[38];
	let t19;
	$[39] !== t16 || $[40] !== t18 ? (t19 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Stack, {
		marginTop: 4,
		space: 2,
		children: [t16, t18]
	}), $[39] = t16, $[40] = t18, $[41] = t19) : t19 = $[41];
	let t20;
	$[42] !== helpId || $[43] !== t ? (t20 = helpId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		marginTop: 4,
	...
	let t22;
	$[47] !== handleReload || $[48] !== t21 ? (t22 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		marginTop: 4,
	...
	let t23;
	$[50] !== T0 || $[51] !== t19 || $[52] !== t2 || $[53] !== t20 || $[54] !== t22 || $[55] !== t3 || $[56] !== t4 || $[57] !== t5 || $[58] !== t6 || $[59] !== t7 || $[60] !== t8 ? (t23 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(T0, {
		marginTop: t2,
		padding: t3,
		radius: t4,
		overflow: t5,
	...
	let t24;
	$[62] !== T1 || $[63] !== t23 || $[64] !== t9 ? (t24 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(T1, { children: [t9, t23] }), $[62] = T1, $[63] = t23, $[64] = t9, $[65] = t24) : t24 = $[65];
	let t25;
	return $[66] !== T2 || $[67] !== t10 || $[68] !== t11 || $[69] !== t12 || $[70] !== t13 || $[71] !== t14 || $[72] !== t24 ? (t25 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T2, {
		height: t10,
		overflow: t11,
		padding: t12,
		sizing: t13,
...
function NoDocumentTypesScreen() {
	const $ = (0, import_compiler_runtime.c)(17), { t } = useTranslation(structureLocaleNamespace);
	let t0;
	$[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		size: 1,
	...
	let t6;
	$[11] !== t5 ? (t6 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		as: "p",
		muted: !0,
		size: 1,
...
var StyledPaneLayout = /* @__PURE__ */ gt(PaneLayout).withConfig({
...
var StructureTool = (0, import_react.memo)(function(t0) {
	const $ = (0, import_compiler_runtime.c)(58), { onPaneChange } = t0, { push: pushToast } = useToast(), schema = useSchema(), { navigate } = useRouter(), routerState = useRouterState(), { layoutCollapsed, setLayoutCollapsed } = useStructureTool(), resolvedPanesValue = useResolvedPanes(), { paneDataItems, resolvedPanes, setMaximizedPane, maximizedPane } = resolvedPanesValue, isResolvingIntent = useRouterState(_temp$1), { sanity: t1 } = useTheme$1(), { media } = t1, [portalElement, setPortalElement] = (0, import_react.useState)(null);
	let t2;
	...
	if ($[27] !== maximizedPane || $[28] !== paneDataItems || $[29] !== setMaximizedPane ? (t13 = () => {
		...
		paneDataItems,
		setMaximizedPane
	], $[27] = maximizedPane, $[28] = paneDataItems, $[29] = setMaximizedPane, $[30] = t13, $[31] = t14) : (t13 = $[30], t14 = $[31]), (0, import_react.useEffect)(t13, t14), !hasDefinedDocumentTypes) {
		let t152;
		return $[32] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t152 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NoDocumentTypesScreen, {}), $[32] = t152) : t152 = $[32], t152;
	}
	...
	if ($[33] !== onSetMaximizedPane || $[34] !== paneItemsToShow) {
		...
		$[36] !== onSetMaximizedPane ? (t192 = (paneData_0) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: pane_5 === LOADING_PANE ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingPane, {
				paneKey,
				path,
				selected
			...
			}) }, `${pane_5 === LOADING_PANE ? "loading" : pane_5.type}-${paneIndex}`);
		}, $[36] = onSetMaximizedPane, $[37] = t192) : t192 = $[37], t18 = paneItemsToShow.map(t192), $[33] = onSetMaximizedPane, $[34] = paneItemsToShow, $[35] = t18;
	} else t18 = $[35];
	let t19;
	$[38] !== isResolvingIntent || $[39] !== paneDataItems.length ? (t19 = paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoadingPane, { paneKey: "intent-resolver" }), $[38] = isResolvingIntent, $[39] = paneDataItems.length, $[40] = t19) : t19 = $[40];
	let t20;
	$[41] !== handleRootCollapse || $[42] !== handleRootExpand || $[43] !== media[1] || $[44] !== t16 || $[45] !== t18 || $[46] !== t19 ? (t20 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StyledPaneLayout, {
		flex: 1,
		height: t16,
		minWidth: t17,
	...
	let t21;
	$[48] !== resolvedPanes ? (t21 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StructureTitle, { resolvedPanes }), $[48] = resolvedPanes, $[49] = t21) : t21 = $[49];
	let t22;
	$[50] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"data-portal": "",
		ref: setPortalElement
	}), $[50] = t22) : t22 = $[50];
	let t23;
	$[51] !== t15 || $[52] !== t20 || $[53] !== t21 ? (t23 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PortalProvider, {
		element: t15,
		children: [
			t20,
			t21,
	...
	let t24;
	return $[55] !== resolvedPanesValue || $[56] !== t23 ? (t24 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResolvedPanesProvider, {
...
function StructureToolBoundary(t0) {
	const $ = (0, import_compiler_runtime.c)(14), { tool: t1 } = t0, { options } = t1, { unstable_sources: sources } = useWorkspace(), [firstSource] = sources;
	let t2;
	...
	let t4;
	$[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t4 = { error: null }, $[3] = t4) : t4 = $[3];
	const [t5, setError] = (0, import_react.useState)(t4), { error } = t5;
	if (error) {
		let t62;
		return $[4] !== error ? (t62 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StructureError, { error }), $[4] = error, $[5] = t62) : t62 = $[5], t62;
	}
	const t6 = source || firstSource.name;
	let t7, t8;
	$[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t7 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StructureTool, { onPaneChange: setActivePanes }), t8 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IntentResolver, {}), $[6] = t7, $[7] = t8) : (t7 = $[6], t8 = $[7]);
	let t9;
	...
	let t10;
	return $[11] !== t6 || $[12] !== t9 ? (t10 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorBoundary, {
		onCatch: setError,
