...
export const metadata = {
  title: 'Sign Up - Back to Protocol',
};
      ...
      <div className="flex-1 flex items-center justify-center py-12">
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <p className="text-neutral-700">Join our community</p>
          </div>
          ...
          <p className="text-center text-neutral-700">
            Already have an account? <Link href="/auth/signin" className="text-primary-700 font-semibold hover:text-primary-800">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
